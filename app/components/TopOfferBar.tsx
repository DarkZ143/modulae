...
"use client";
import { FaBolt, FaMapMarkerAlt, FaThumbtack } from "react-icons/fa";

const TopOfferBar = () => {
  return (
    <div className="hidden md:flex justify-between items-center px-8 py-4 text-sm bg-gradient-to-r from-[#0d0d0d] via-[#1a1a1a] to-[#0f243d] text-gray-300">
      {/* Left side */}
