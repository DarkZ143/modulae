            ...
            <div className="max-w-6xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div className="lg:col-span-2 space-y-6">
                    {Object.entries(cart).map(([slug, item]) => (
                        <div
                            key={slug}
                            className="bg-white shadow-sm hover:shadow-md transition rounded-xl border border-gray-200 p-4 flex gap-6"
                        >
                            {/* Product Image */}
                            <Image
                                src={item.image}
                            ...
                            <div className="flex-1 space-y-2">
                                ...
                                <div className="flex items-center gap-4 mt-3">
                                    <button
                                        onClick={() => updateQty(slug, item.qty - 1)}
                                        className="w-8 h-8 flex items-center justify-center bg-gray-200 hover:bg-gray-300 rounded-md text-lg"
                                    >
                                        -
                                    </button>
                                ...
                                <button
                                    ...
                                    className="text-red-500 text-sm underline hover:text-red-700 mt-2"
                                >
                                    Remove Item
                                </button>
                            </div>
                ...
                <div className="bg-white shadow-md rounded-xl border border-gray-200 p-6 h-fit sticky top-28">
                    ...
                    <a
                        href="/checkout"
                        className="block mt-6 bg-orange-500 hover:bg-orange-600 text-white text-center py-3 rounded-lg font-semibold shadow"
                    >
                        Proceed to Checkout
                    </a>
                </div>
